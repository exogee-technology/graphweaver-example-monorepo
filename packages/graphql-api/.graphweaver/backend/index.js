...
__decorateClass(
	[(0, import_graphweaver.SummaryField)(), (0, import_graphweaver.Field)(() => String)],
	Post.prototype,
	'title',
	2
);
__decorateClass([(0, import_graphweaver.Field)(() => String)], Post.prototype, 'body', 2);
__decorateClass([(0, import_graphweaver.Field)(() => String)], Post.prototype, 'userId', 2);
Post = __decorateClass([(0, import_graphweaver.ObjectType)('Post')], Post);
...
PostResolver = __decorateClass([(0, import_graphweaver2.Resolver)(() => Post)], PostResolver);
